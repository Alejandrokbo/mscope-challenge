...
:rouge-style: github
:pdf-theme: themes/mscope-theme.yml
:pdf-themesdir: themes
:imagesdir: images
:chapter-label!:           // <- desactiva "Chapter"
...
* Integración con proveedores locales (ej: Clave Fiscal Argentina)
...
*5. Deploy Dev* → Auto-deploy (branch develop) + Smoke tests + Notificación Slack
...
* Read replicas en regiones target (EU, LATAM)
